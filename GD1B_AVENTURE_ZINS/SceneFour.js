class SceneFour extends Phaser.Scene{
    ...
    create(){
        ...
        player = this.physics.add.sprite(560, 80, 'player');
        ...
        function collecteCoffre(player, coffres){
            ...
            this.add.text(player.x+400, player.y+300, 'Vous avez gagné', { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif' }); 
            this.physics.pause();
        }
